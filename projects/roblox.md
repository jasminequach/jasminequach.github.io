...
<img class="img-fluid" src="../projects/images/cottage-interior.png" style="width: 500px; float: right; margin-left: 20px; margin-bottom: 20px; margin-top: 10px; border-radius: 15px;">
